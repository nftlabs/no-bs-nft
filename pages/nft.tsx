...
export default function NFT(): JSX.Element {
    const testDescription = `COLORISMS is both a piece of digital art as
            ...
            <ContentWrapper>
                ...
                <div className="flex flex-col mt-8 mb-32">
                    <Center>
                        ...
                        >
                            <Image src="/test-art.jpg" height={248} width={329} />
                        </div>
                    </Center>
                            ...
                            <Stack px="4" spacing="4" width="400px">
                                ...
                                <Center>
                                    <div className="flex justify-center items-center">
                                        <p className="text-2xl text-gray-700 font-bold mx-2">800</p>

                                        <Image src="/usdc-logo.svg" height={24} width={24} />
                                    </div>
                                </Center>
